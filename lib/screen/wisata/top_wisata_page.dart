...
class TopWisataPage extends StatelessWidget {
  ...
  Widget _buildEmptyState(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 20),
        Padding(padding: const EdgeInsets.symmetric(horizontal: 24), child: _buildHeader(context)),
        Expanded(child: Center(child: Text("Belum ada data wisata", style: TextStyle(color: Colors.grey[600])))),
      ],
    );
  }
    ...
    return Row(
      ...
      children: [
        ...
        Image.asset(
          ...
          height: 36,
          fit: BoxFit.contain,
          errorBuilder: (context, error, stackTrace) => const Text("JOKKA", style: TextStyle(fontWeight: FontWeight.bold)),
        ),
...
class _TopRankHorizontalCard extends StatelessWidget {
  ...
  const _TopRankHorizontalCard({required this.data, required this.rank});
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(" ${data['rating'] ?? 0}", style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold)),
              ],
            )
          ],
        ),
...
class _WisataListCard extends StatelessWidget {
  ...
  const _WisataListCard({required this.data, required this.rank});
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(rank, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 10, color: Colors.black54)),
          ),
