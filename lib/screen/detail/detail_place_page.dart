                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Expanded(
                            child: Text(widget.placeData['location'] ?? '-',
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(widget.placeData['price'] ?? 'Gratis',
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                    ...
                    const Text("Lokasi Peta (Google Maps)",
                        style: TextStyle(
                            fontSize: 18, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 12),
                    Container(
                        ...
                        child: hasLocation
                            ? GoogleMap(
                                ...
                                initialCameraPosition: CameraPosition(
                                    target: placeLocation, zoom: 15.0),
                                markers: _markers,
                              )
                            : const Center(
